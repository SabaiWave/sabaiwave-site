...
type ThreadSpec = {
  id: string;
  d: string;
  stroke: "url(#threadFade1)" | "url(#threadFade2)" | "url(#threadFade3)";
  strokeWidth: number;
  opacity: number;
  circleR: number;
  circleFill: "url(#neonPulse1)" | "url(#neonPulse2)" | "url(#neonPulse3)";
  dur: string;
};
...
type Props = {
  ...
  offsetY?: number; // negative moves waves UP
};

export function BackgroundWaves({ enableAnimations, offsetY = 0 }: Props) {
  return (
    <div
      aria-hidden="true"
        ...
        >
          <defs>
            <radialGradient id="neonPulse1" cx="50%" cy="50%" r="50%">
              ...
              <stop offset="30%" stopColor="rgba(47,164,169,1)" />
              <stop offset="70%" stopColor="rgba(47,164,169,0.8)" />
              <stop offset="100%" stopColor="rgba(47,164,169,0)" />
            </radialGradient>
            <radialGradient id="neonPulse2" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="rgba(255,255,255,0.9)" />
              <stop offset="25%" stopColor="rgba(47,164,169,0.9)" />
              <stop offset="60%" stopColor="rgba(47,164,169,0.7)" />
              <stop offset="100%" stopColor="rgba(47,164,169,0)" />
            </radialGradient>
            <radialGradient id="neonPulse3" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="rgba(255,255,255,1)" />
              <stop offset="35%" stopColor="rgba(47,164,169,1)" />
              <stop offset="75%" stopColor="rgba(47,164,169,0.6)" />
              <stop offset="100%" stopColor="rgba(47,164,169,0)" />
            </radialGradient>

            <radialGradient id="heroTextBg" cx="30%" cy="50%" r="70%">
              <stop offset="0%" stopColor="rgba(47,164,169,0.15)" />
              <stop offset="40%" stopColor="rgba(47,164,169,0.08)" />
              <stop offset="80%" stopColor="rgba(47,164,169,0.05)" />
            ...
            <linearGradient id="threadFade1" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="15%" stopColor="rgba(47,164,169,0.8)" />
              <stop offset="85%" stopColor="rgba(47,164,169,0.8)" />
              <stop offset="100%" stopColor="rgba(0,0,0,1)" />
            </linearGradient>
            <linearGradient id="threadFade2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgba(0,0,0,1)" />
              <stop offset="12%" stopColor="rgba(47,164,169,0.7)" />
              <stop offset="88%" stopColor="rgba(47,164,169,0.7)" />
              <stop offset="100%" stopColor="rgba(0,0,0,1)" />
            </linearGradient>
            <linearGradient id="threadFade3" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgba(0,0,0,1)" />
              <stop offset="18%" stopColor="rgba(47,164,169,0.8)" />
              <stop offset="82%" stopColor="rgba(47,164,169,0.8)" />
              <stop offset="100%" stopColor="rgba(0,0,0,1)" />
            </linearGradient>
