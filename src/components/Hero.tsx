...
const Hero: React.FC = () => {
  const showStoreButtons = flags.SHOW_STORE_BUTTONS;

  return (
    <section
      id="hero"
      className="relative flex items-center justify-center pt-32 md:pt-40 pb-12 md:pb-16 px-5"
    >
      ...
      <div className="text-center">
        ...
        <Image
          ...
          className={`relative mx-auto z-10 ${
            showStoreButtons ? "mt-12 md:mt-16" : "mt-8 md:mt-12"
          }`}
        />
      </div>
    </section>
